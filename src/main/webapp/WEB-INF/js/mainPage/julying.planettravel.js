...
(function($){
	...
	$.fn.planetTravel.defaults = {
		bgCss				: ['planetTravelBg_1' ,'planetTravelBg_2' ,'planetTravelBg_3', 'planetTravelBg_4'],
		flyStarImage		: [ [path+'/img/mainPage/star-fly-1.png' , 23 ,23 ] ],/*星星图片地址.地址，宽度，高度*/	
		...
		flashStarImage		: [ [path +'/img/mainPage/star-flash-1.png' , 30 ,27 ] , [ path +'/img/mainPage/star-flash-2.png' , 40 ,40 ], [ path +'/img/mainPage/star-flash-2.png' , 40 ,40 ] ],/*星星图片地址 。地址，宽度，高度  */
